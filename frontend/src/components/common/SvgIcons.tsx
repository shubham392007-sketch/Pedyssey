...
export const PdfIcon: React.FC<IconProps> = ({ className = "w-5 h-5", size }) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
export const AiSparkIcon: React.FC<IconProps> = ({ className = "w-5 h-5", size }) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
export const CitationIcon: React.FC<IconProps> = ({ className = "w-5 h-5", size }) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
export const LockShieldIcon: React.FC<IconProps> = ({ className = "w-5 h-5", size }) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
export const NetworkIcon: React.FC<IconProps> = ({ className = "w-5 h-5", size }) => (
  ...
  >
    ...
    <line x1="8.59" y1="13.51" x2="6.42" y2="16.49" />
    <line x1="15.41" y1="13.51" x2="17.58" y2="16.49" />
...
/* Social SVGs */
export const GithubSvg: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
...
export const InstagramSvg: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
...
export const LinkedInSvg: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
...
export const MailSvg: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const XSvg: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
